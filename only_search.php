...
<a href="index.php"  style="background-color:black; color:white; width:60px; height:30px; position:relative; right;-500px; top:0px;margin-left:5px;font-size:18px;"><i class="material-icons" style="font-size:18px;">home</i>HOME</a>
...
if($result = mysqli_query($con, $sql)){
	...
	if(mysqli_num_rows($result) > 0){
		...
		echo "<h4  style='position:absolute; top:13px; left:370px;'>TO APPLY <a href='index.php'>go back</a> and log in .</h4>";
    } else{
